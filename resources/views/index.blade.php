...
<html>
  ...
  <body class="menu-position-side menu-side-left full-screen with-content-panel">
            ...
            <div class="onboarding-slider-w">
              <div class="onboarding-slide">
                <div class="onboarding-media">
                  <img alt="" src="public/backend/img/bigicon2.png" width="200px">
                </div>
              ...
              <div class="onboarding-slide">
                <div class="onboarding-media">
                  <img alt="" src="public/backend/img/bigicon5.png" width="200px">
                </div>
                <div class="onboarding-content with-gradient">
                  <h4 class="onboarding-title">
              ...
              <div class="onboarding-slide">
                <div class="onboarding-media">
                  <img alt="" src="public/backend/img/bigicon6.png" width="200px">
                </div>
                <div class="onboarding-content with-gradient">
                  <h4 class="onboarding-title">
            ...
            <div class="ssg-content">
              <div class="ssg-items ssg-items-boxed">
                <a class="ssg-item" href="users_profile_big.html">
                  <div class="item-media" style="background-image: url(public/backend/img/company6.png)"></div>
                  <div class="item-name">
                    Integ<span>ration</span> with API
                  </div>
                </a><a class="ssg-item" href="users_profile_big.html">
                  <div class="item-media" style="background-image: url(public/backend/img/company7.png)"></div>
                  <div class="item-name">
          ...
          <div class="search-suggestions-group">
            ...
            <div class="ssg-content">
              <div class="ssg-items ssg-items-list">
                <a class="ssg-item" href="users_profile_big.html">
                  <div class="item-media" style="background-image: url(public/backend/img/avatar1.jpg)"></div>
                  <div class="item-name">
                    John Ma<span>yer</span>s
                  </div>
                </a><a class="ssg-item" href="users_profile_big.html">
                  <div class="item-media" style="background-image: url(public/backend/img/avatar2.jpg)"></div>
                  <div class="item-name">
                    Th<span>omas</span> Mullier
                  </div>
                </a><a class="ssg-item" href="users_profile_big.html">
                  <div class="item-media" style="background-image: url(public/backend/img/avatar3.jpg)"></div>
                  <div class="item-name">
      ...
      <div class="layout-w">
        ...
        <div class="menu-mobile menu-activated-on-click color-scheme-dark">
          <div class="mm-logo-buttons-w">
            <a class="mm-logo" href="index.html"><img src="public/backend/img/logo.png"><span>Clean Admin</span></a>
          ...
          <div class="menu-and-user">
            <div class="logged-user-w">
              <div class="avatar-w">
                <img alt="" src="public/backend/img/avatar1.jpg">
              </div>
              ...
              <div class="os-dropdown light message-list">
                <ul>
                  ...
                  <li>
                    <a href="#">
                      <div class="user-avatar-w">
                        <img alt="" src="public/backend/img/avatar2.jpg">
                      </div>
                      <div class="message-content">
                        <h6 class="message-from">
                          Phil Jones
                  ...
                  <li>
                    <a href="#">
                      <div class="user-avatar-w">
                        <img alt="" src="public/backend/img/avatar3.jpg">
                      </div>
                      <div class="message-content">
                        <h6 class="message-from">
                          Bekky Simpson
                  ...
                  <li>
                    <a href="#">
                      <div class="user-avatar-w">
                        <img alt="" src="public/backend/img/avatar4.jpg">
                      </div>
                      <div class="message-content">
                        <h6 class="message-from">
                          Alice Priskon
                  ...
                  <div class="logged-user-menu color-style-bright">
                    ...
                    <ul>
                      ...
                      <li>
                       ...
                       <li>
                        <a href="{{route('login.logout')}}"><i class="os-icon os-icon-signs-11"></i><span>Logout</span></a>
                      </li>
                      
                     @if(Session::has('sucsess'))
                      <li>
                        <a href="{{route('login.getlogin')}}"><i class="os-icon os-icon-signs-11"></i><span>login</span></a>
                      </li>@endif
                        ...
                        <table class="table table-lightborder">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <div class="cell-image-list">
                                  <div class="cell-img" style="background-image: url(public/backend/img/portfolio9.jpg)"></div>
                                  <div class="cell-img" style="background-image: url(public/backend/img/portfolio2.jpg)"></div>
                                  <div class="cell-img" style="background-image: url(public/backend/img/portfolio12.jpg)"></div>
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="cell-image-list">
                                  <div class="cell-img" style="background-image: url(public/backend/img/portfolio14.jpg)"></div>
                                  <div class="cell-img" style="background-image: url(public/backend/img/portfolio8.jpg)"></div>
                                </div>
                              </td>
                              <td class="text-center">
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="cell-image-list">
                                  <div class="cell-img" style="background-image: url(public/backend/img/portfolio16.jpg)"></div>
                                  <div class="cell-img" style="background-image: url(public/backend/img/portfolio14.jpg)"></div>
                                  <div class="cell-img" style="background-image: url(public/backend/img/portfolio5.jpg)"></div>
                                </div>
                              </td>
                              <td class="text-center">
                                <div class="status-pill green" data-title="Complete" data-toggle="tooltip"></div>
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="cell-image-list">
                                  <div class="cell-img" style="background-image: url(public/backend/img/portfolio1.jpg)"></div>
                                  <div class="cell-img" style="background-image: url(public/backend/img/portfolio5.jpg)"></div>
                                  <div class="cell-img" style="background-image: url(public/backend/img/portfolio6.jpg)"></div>
                                  <div class="cell-img-more">
                                    + 2 more
                                  </div>
                                </div>
                        ...
                        <table class="table table-bordered table-lg table-v2 table-striped">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <img alt="" src="public/backend/img/flags-icons/us.png" width="25px">
                              </td>
                              <td class="text-right">
                                $245
                              </td>
                            ...
                            <tr>
                              ...
                              <td>
                                <img alt="" src="public/backend/img/flags-icons/fr.png" width="25px">
                              </td>
                              <td class="text-right">
                                $154
                              </td>
                            ...
                            <tr>
                              ...
                              <td>
                                <img alt="" src="public/backend/img/flags-icons/ca.png" width="25px">
                              </td>
                              <td class="text-right">
                                $112
                              </td>
    ...
    <script src="{{asset('public/backend/js/demo_customizer.js?version=4.5.0')}}"></script>
    <script src="{{asset('public/backend/js/main.js?version=4.5.0')}}"></script>
    <script>
